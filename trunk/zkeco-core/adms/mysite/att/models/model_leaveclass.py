...
from dbapp.field_extend import ColorField
...
class LeaveClass(CachingModel):
        ...
        LeaveType=models.SmallIntegerField(_(u'所属类型'), null=False,default=1,blank=False, editable=True,choices=LEAVETYPE) #0 未知  1 病假 2事假 3产假 4探亲假 5年假
