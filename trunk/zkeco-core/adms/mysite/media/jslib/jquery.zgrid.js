        ...
        var g={
            ...
            render_tbl:function(){//按照配置条件，生成html列表
                ...
                for(var i in data){
                    ...
                    html_row="<tr class='row"+(i%2)+"' title='"+display+"' data='"+key+"' id='id_row_"+i+"'>";
                    if(g.multiple_select!=null){
                    ...
                    for(var j=0;j<row.length;j++){
                        if(disable_cols.indexOf(","+fields[j]+",")==-1){
                            ...
                            /*if(txt.length>25){
                               $row_txt=$row_txt.text(txt.substr(0,25)).html();
                            }else{
                                $row_txt=$row_txt.html();
                            }*/
                            if(flag==1 && g.detail_model && g.detail_model.length!=0 && g.need_plus_sign){
                                var a_image="<a class='child_show' alt='master_detail"+i+"'></a>";
                                html_row+="<td title='"+txt+"' class='Link_blue1'>"+a_image+v_txt+"</td>";
                            }else if(flag==1){
                                if(g.obj_edit){
                                    html_row+="<td title='"+txt+"' class='Link_blue1'><a class='obj_edit_href' ref='"+key+"' href='javascript:void(0);'>"+v_txt+"</a></td>";
                                }else{
                                    html_row+="<td title='"+txt+"'>"+v_txt+"</td>";
                                }
                            }else{
                                html_row+="<td title='"+txt+"'>"+v_txt+"</td>";
                            }
...
//                }
				...
				if(g.scrollable && g.layout=="table" ){
            ...
            switch_layout:function(){
                ...
                var $show_style=$("<div id='id_show_style'  class='div_id_middiv div_show_style floatR'></div>");
                ...
                $("input",$show_style).click(function(){
                    g.layout=$(this).val();
                    g.reload_data();
                });
                ...
                if(g.layout=="photo"){
                    ...
                    $.each($trs,function(ii,ee){
						...
						if (src_tran == "") {
							...
							var $img_div = $("<div class='obj_photo'><span><img  onerror=\"this.src='/media/images/userImage_default.gif'\" class='list_img' width='75px' height='90px' src='" + src + "'/></span></div><div class='obj_photo'><span><img  onerror=\"this.src='/media/images/userImage_default.gif'\" class='list_img' width='75px' height='90px' src='" + src_tran + "'/></span></div>");
						}
