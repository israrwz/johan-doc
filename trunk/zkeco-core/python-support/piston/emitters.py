...
class Emitter(object):
    ...
    def method_fields(self, handler, fields):
        ...
        for field in fields:
            if field not in Emitter.RESERVED_FIELDS:
    ...
    def construct(self):
        ...
        def _fk(data, field):
            ...
            if value is None:
                value=smart_unicode(getattr(data, field.name))
        ...
        def _model(data, fields=()):
            ...
            if handler or fields:
                ...
                get_fields=get_fields_with_filter.keys()
                ...
                for maybe_field in get_fields:
                    if "." in maybe_field: 
                        ...
                        if obj:
                            ...
                            ret[maybe_field]=""
                    elif isinstance(maybe_field, (list, tuple)):
...
class XMLEmitter(Emitter):
    def _to_xml(self, xml, data):
        if isinstance(data, (list, tuple)):
            ...
            xml.characters(smart_unicode(data or ""))
