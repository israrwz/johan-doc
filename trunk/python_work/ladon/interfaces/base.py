...
class BaseInterface(object):
	...
	def build_fault_response(self,exc,methodname=None,encoding='UTF-8'):
		return self._fault_handler.build_fault_response(exc,self._sinfo,methodname,encoding)
	...
	def description(self,service_url,encoding='UTF-8'):
...
class ServiceDescriptor(object):
	...
	def generate(self,servicename,servicenumber,typemanager,methodlist,encoding):
		"""
