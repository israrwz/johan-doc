...
#################################### for DictMixin    parse_qs    pickle    json_dumps
...
try: from json import dumps as json_dumps
    ...
    try: from simplejson import dumps as json_dumps
        ...
        try: from django.utils.simplejson import dumps as json_dumps
            ...
            json_dumps = None
#################################### for  BytesIO    NCTextIOWrapper    bytes    tonat (Convert anything to native strings)
...
####################################   for depr    makelist    cached_property    DictProperty    lazy_attribute
