...
/* Static server configuration */ // 静态服务器配置宏
#define REDIS_SERVERPORT        6379    /* TCP port */ //端口
#define REDIS_MAXIDLETIME       (60*5)  /* default client timeout */ //超时时间
#define REDIS_IOBUF_LEN         1024 // IO 操作缓冲区大小
#define REDIS_LOADBUF_LEN       1024 // 加载缓冲区大小
#define REDIS_STATIC_ARGS       8 //静态参数
#define REDIS_DEFAULT_DBNUM     16 // 默认db数目
#define REDIS_CONFIGLINE_MAX    1024 // 配置文件行数
#define REDIS_MAX_SYNC_TIME     60      /* Slave can't take more to sync */ // sync 时间
#define REDIS_EXPIRELOOKUPS_PER_CRON    10 /* lookup 10 expires per loop */ //循环到期时间
#define REDIS_MAX_WRITE_PER_EVENT (1024*64) // 写事件操作区大小
#define REDIS_REQUEST_MAX_SIZE (1024*1024*256) /* max bytes in inline command */ // 最大请求大小
#define REDIS_SHARED_INTEGERS 10000 // 共享数量
#define REDIS_REPLY_CHUNK_BYTES (5*1500) /* 5 TCP packets with default MTU */ // 回应字节块大小
#define REDIS_MAX_LOGMSG_LEN    1024 /* Default maximum length of syslog messages */ //系统日志最大长度
...
#define REDIS_LRU_CLOCK_RESOLUTION 10 /* LRU clock resolution in seconds */  //最近最少使用时钟频率
