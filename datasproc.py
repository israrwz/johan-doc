...
def ConstructBaseFields_sf():
        r={}
        strFieldNames=['deptid','badgenumber','username','ssn']
        FieldNames=['userid','badgenumber','deptid','username','duty','realduty','late','early','absent','checkexact','Leave']
        for t in FieldNames:
                if t in strFieldNames:
                        r[t]=''
                else:
                        r[t]=''
        r['userid']=-1;
        FieldCaption=[_(u'用户ID'),_(u'人员编号'),_(u'单位'),_(u'姓名'),_(u'应出勤'),_(u'实出勤'),_(u'迟到'),_(u'早退'),_(u'旷工'),_(u'补签'), _(u'请假合计')]
        return [r,FieldNames,FieldCaption]
